...
# -*- coding: utf-8 -*-
# =============================================================================
# Dream Homes NYC – Enhanced ETL Script
# =============================================================================
# This script processes real estate transaction data from a CSV file and 
# loads it into a PostgreSQL database. It handles data related to properties, 
# transactions, agents, clients, commissions, leases, and more.
#
# Data Source:
# - File type: CSV
# - File name: dream_homes_nyc_dataset_v8.csv
# - Description: Contains structured information on listings, sales/rentals,
#   agents, clients, appointment history, and marketing efforts.
#
# Target Database:
# - Type: PostgreSQL
# - Name: dream_homes_db (or as configured in config.py)
# - Description: Normalized schema to store and query real estate data.
#
# ETL Flow:
# For each row in the CSV:
#   1. Extract the raw data.
#   2. Transform:
#      - Clean and parse text fields (e.g., addresses, names, monetary values).
#      - Convert types and map enums (e.g., property type, transaction status).
#   3. Load:
#      - Insert or update records in multiple tables in a specific order 
#        (Office → Agent → Client → Property → Transaction).
#      - Related entities like Appointments, Documents, etc., are handled 
#        separately to avoid full failure if any non-critical insert fails.
#
# Table Mapping Overview:
#
# -- Office --
# - Uses: listing_office_name, address, phone
# - Logic: Insert if not already present, otherwise return existing office_id
#
# -- Employee --
# - Handles both listing and selling agents
# - Uses: name, email, phone, commission_rate
# - Checks for existing email before inserting
#
# -- Client / ClientRole --
# - Handles buyer/seller/renter/landlord roles
# - Uses: client info, contact details
# - Roles assigned based on transaction type
#
# -- PropertyType --
# - Uses: property_type
# - Abbreviated values like "TH" are mapped to full terms like "Townhouse"
#
# -- Property --
# - Core listing info (MLS number, address, price, beds/baths, etc.)
# - MLS number used as unique identifier
#
# -- PropertyFeature --
# - Uses: property_features_list
# - Split into individual rows, stored as amenities
#
# -- Transaction --
# - Captures the actual deal (sale or rental)
# - Includes offer date, final price, closing date, etc.
#
# -- Appointment --
# - Parsed from appointment_history
# - Each record includes date, type, attendees, notes
#
# -- Commission --
# - Based on commission_total and optional split info
# - Handles payout breakdown by agent
#
# -- Document --
# - Uses: documents_required + appraisal amount
# - Each required document is recorded with a type and placeholder file path
#
# -- ClientLead --
# - Uses: client_buyer_info + lead_source
# - Creates a lead entry for the property based on budget
#
# -- PropertyMedia --
# - Adds a default photo and floor plan for each property
# - File path is standardized using property_id
#
# -- Lease + PaymentRecord --
# - For rentals: builds a lease period and inserts payment records
# - Includes monthly rent and security deposit
#
# -- MarketingCampaign --
# - Uses: campaign_type and marketing_spend
# - Records campaign details with type mapped to enum
#
# Notes:
# - Insert operations include checks to avoid duplicates
# - Many insertions are wrapped in independent transactions to isolate failures
# - Parsing helpers are used for consistent date, numeric, and string handling
# =============================================================================
